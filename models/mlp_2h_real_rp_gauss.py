...
def preamble(i):
    ...
    module = os.path.join(train_folder, 'mlp_2h_real_rp_gauss.py')
    ...
    slurm_preamble = '#SBATCH -J MLP_2hiddens_rp_gauss%d\n' % (i)
...
def load_data(pars):
   data = h5.File('/nthome/maugust/thesis/train_val_test_rp_real_gauss.hdf','r')
