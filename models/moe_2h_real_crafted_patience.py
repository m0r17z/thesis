...
from breze.learn.mlp import MoE
...
def preamble(i):
    ...
    module = os.path.join(train_folder, 'moe_2h_real_crafted_patience.py')
...
def draw_pars(n=1):
    ...
    grid = {
        'n_hidden_man': [[200,200],[500,500],[1000,1000],[700,700],[100,100],[50,50]],
        'n_hidden_exp': [[200,200],[500,500],[1000,1000],[700,700],[100,100],[50,50]],
        'hidden_transfers_man': [['sigmoid','sigmoid'], ['tanh','tanh'], ['rectifier','rectifier']],
        'hidden_transfers_exp': [['sigmoid','sigmoid'], ['tanh','tanh'], ['rectifier','rectifier']],
