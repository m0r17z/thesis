...
def preamble(i):
    ...
    module = os.path.join(train_folder, 'mlp_2h_real_crafted_wo_meancovar.py')
...
def load_data(pars):
   data = h5.File('/nthome/maugust/thesis/train_val_test_crafted_real_int_wo_meancovar.hdf5','r')
