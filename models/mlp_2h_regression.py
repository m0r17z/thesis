...
def preamble(i):
    ...
    module = os.path.join(train_folder, 'mlp_2h_regression.py')
...
def load_data(pars):
   data = h5.File('/nthome/maugust/thesis/train_val_test_binning_real_regression.hdf5','r')
...
def new_trainer(pars, data):
    ...
    m = Mlp(input_size, pars['n_hidden'], output_size,
            ...
            loss='squared', batch_size = batch_size,
