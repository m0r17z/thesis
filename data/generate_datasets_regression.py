...
def generate_train_val_test_set(raw_data, final_data):
    ...
    f.create_dataset('trainig_labels/real_train_labels', (train_len, 2), dtype='i')
    f.create_dataset('validation_labels/real_val_labels', (val_len, 2), dtype='i')
    f.create_dataset('test_labels/real_test_labels', (test_len, 2), dtype='i')
