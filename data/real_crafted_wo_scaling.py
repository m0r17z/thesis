...
def generate_real_dataset_crafted():
    ...
    f = h5.File("./crafted_real_int_wo_scaling.hdf5", "w")
    ...
    generate_train_val_test_set("./crafted_real_int_wo_scaling.hdf5", "train_val_test_crafted_real_int_wo_scaling.hdf5")
