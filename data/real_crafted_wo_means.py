...
def generate_real_dataset_crafted():
    ...
    f = h5.File("./crafted_real_int_wo_meancovar.hdf5", "w")
    f.create_dataset('data_set/data_set', (len(good_samples),48), dtype='f')
    ...
    generate_train_val_test_set("./crafted_real_int_wo_meancovar.hdf5", "train_val_test_crafted_real_int_wo_meancovar.hdf5")
