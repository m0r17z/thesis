...
def compute_markov_table():
    ...
    for row in np.arange(13):
        stat_table[row] /= np.sum(stat_table[row])
    ...
    for row in np.arange(13):
        posterior_table[row] /= np.sum(posterior_table[row])

    posterior_table[0][0] = 1./11
    posterior_table[0][1] = 1./11
    posterior_table[0][2] = 1./11
    posterior_table[0][3] = 1./11
    posterior_table[0][4] = 1./11
    posterior_table[0][5] = 1./11
    posterior_table[0][6] = 0.
    posterior_table[0][7] = 0.
    posterior_table[0][8] = 1./11
    posterior_table[0][9] = 1./11
    posterior_table[0][10] = 1./11
    posterior_table[0][11] = 1./11
    posterior_table[0][12] = 1./11
