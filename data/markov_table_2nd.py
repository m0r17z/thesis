...
def compute_markov_table():
    ...
    prior_table[6][0][8] = 0.
    prior_table[6][0][9] = 0.
    prior_table[6][0][10] = 0.
    prior_table[6][0][11] = 0.
    prior_table[6][0][12] = 0.
    ...
    prior_table[7][0][8] = 0.
    prior_table[7][0][9] = 0.
    prior_table[7][0][10] = 0.
    prior_table[7][0][11] = 0.
    prior_table[7][0][12] = 0.
    ...
    prior_table[10][1][0] = 0.
    prior_table[10][1][1] = 0.
    prior_table[10][1][2] = 0.
    prior_table[10][1][3] = 0.
    prior_table[10][1][4] = 0.
    prior_table[10][1][5] = 0.
    prior_table[10][1][6] = 0.
    ...
    prior_table[11][1][0] = 0.
    prior_table[11][1][1] = 0.
    prior_table[11][1][2] = 0.
    prior_table[11][1][3] = 0.
    prior_table[11][1][4] = 0.
    prior_table[11][1][5] = 0.
    prior_table[11][1][6] = 0.
    ...
    prior_table[12][1][0] = 0.
    prior_table[12][1][1] = 0.
    prior_table[12][1][2] = 0.
    prior_table[12][1][3] = 0.
    prior_table[12][1][4] = 0.
    prior_table[12][1][5] = 0.
    prior_table[12][1][6] = 0.
    ...
    prior_table[10][2][0] = 0.
    prior_table[10][2][1] = 0.
    prior_table[10][2][2] = 0.
    prior_table[10][2][3] = 0.
    prior_table[10][2][4] = 0.
    prior_table[10][2][5] = 0.
    prior_table[10][2][6] = 0.
    prior_table[10][2][7] = 0.
    ...
    prior_table[11][2][0] = 0.
    prior_table[11][2][1] = 0.
    prior_table[11][2][2] = 0.
    prior_table[11][2][3] = 0.
    prior_table[11][2][4] = 0.
    prior_table[11][2][5] = 0.
    prior_table[11][2][6] = 0.
    prior_table[11][2][7] = 0.
    ...
    prior_table[12][2][0] = 0.
    prior_table[12][2][1] = 0.
    prior_table[12][2][2] = 0.
    prior_table[12][2][3] = 0.
    prior_table[12][2][4] = 0.
    prior_table[12][2][5] = 0.
    prior_table[12][2][6] = 0.
    prior_table[12][2][7] = 0.
    ...
    prior_table[10][3][0] = 0.
    prior_table[10][3][1] = 0.
    prior_table[10][3][2] = 0.
    prior_table[10][3][3] = 0.
    prior_table[10][3][4] = 0.
    prior_table[10][3][5] = 0.
    prior_table[10][3][6] = 0.
    prior_table[10][3][7] = 0.
    prior_table[10][3][8] = 0.
    prior_table[10][3][9] = 0.
    prior_table[10][3][10] = 0.
    prior_table[10][3][11] = 0.
    prior_table[10][3][12] = 0.

    prior_table[11][3][0] = 0.
    prior_table[11][3][1] = 0.
    prior_table[11][3][2] = 0.
    prior_table[11][3][3] = 0.
    prior_table[11][3][4] = 0.
    prior_table[11][3][5] = 0.
    prior_table[11][3][6] = 0.
    prior_table[11][3][7] = 0.
    prior_table[11][3][8] = 0.
    prior_table[11][3][9] = 0.
    prior_table[11][3][10] = 0.
    prior_table[11][3][11] = 0.
    prior_table[11][3][12] = 0.

    prior_table[12][3][0] = 0.
    prior_table[12][3][1] = 0.
    prior_table[12][3][2] = 0.
    prior_table[12][3][3] = 0.
    prior_table[12][3][4] = 0.
    prior_table[12][3][5] = 0.
    prior_table[12][3][6] = 0.
    prior_table[12][3][7] = 0.
    prior_table[12][3][8] = 0.
    ...
    prior_table[11][5][0] = 0.
    prior_table[11][5][1] = 0.
    prior_table[11][5][2] = 0.
    prior_table[11][5][3] = 0.
    prior_table[11][5][4] = 0.
    prior_table[11][5][5] = 0.
    prior_table[11][5][6] = 0.
    prior_table[11][5][7] = 0.
    prior_table[11][5][8] = 0.
    prior_table[11][5][9] = 0.
    prior_table[11][5][10] = 0.
    prior_table[11][5][11] = 0.
    prior_table[11][5][12] = 0.

    prior_table[12][5][0] = 0.
    prior_table[12][5][1] = 0.
    prior_table[12][5][2] = 0.
    prior_table[12][5][3] = 0.
    prior_table[12][5][4] = 0.
    prior_table[12][5][5] = 0.
    prior_table[12][5][6] = 0.
    prior_table[12][5][7] = 0.
    prior_table[12][5][8] = 0.
    prior_table[12][5][9] = 0.
    prior_table[12][5][10] = 0.
    ...
    prior_table[0][6][8] = 0.
    prior_table[0][6][9] = 0.
    prior_table[0][6][10] = 0.
    prior_table[0][6][11] = 0.
    ...
    prior_table[4][6][8] = 0.
    prior_table[4][6][9] = 0.
    prior_table[4][6][10] = 0.
    prior_table[4][6][11] = 0.
    ...
    prior_table[8][6][8] = 0.
    prior_table[8][6][9] = 0.
    prior_table[8][6][10] = 0.
    prior_table[8][6][11] = 0.
    ...
    prior_table[12][6][1] = 0.
    prior_table[12][6][2] = 0.
    prior_table[12][6][3] = 0.
    prior_table[12][6][4] = 0.
    prior_table[12][6][5] = 0.
    prior_table[12][6][6] = 0.
    prior_table[12][6][7] = 0.
    prior_table[12][6][8] = 0.
    prior_table[12][6][9] = 0.
    prior_table[12][6][10] = 0.
    prior_table[12][6][11] = 0.
    ...
    prior_table[0][7][8] = 0.
    prior_table[0][7][9] = 0.
    prior_table[0][7][10] = 0.
    prior_table[0][7][11] = 0.
    prior_table[0][7][12] = 0.
    ...
    prior_table[1][7][8] = 0.
    prior_table[1][7][9] = 0.
    prior_table[1][7][10] = 0.
    prior_table[1][7][11] = 0.
    prior_table[1][7][12] = 0.
    ...
    prior_table[5][7][8] = 0.
    prior_table[5][7][9] = 0.
    prior_table[5][7][10] = 0.
    prior_table[5][7][11] = 0.
    prior_table[5][7][12] = 0.
    ...
    prior_table[9][7][8] = 0.
    prior_table[9][7][9] = 0.
    prior_table[9][7][10] = 0.
    prior_table[9][7][11] = 0.
    prior_table[9][7][12] = 0.
    ...
    prior_table[1][8][11] = 0.
    prior_table[1][8][12] = 0.
    ...
    prior_table[2][8][11] = 0.
    prior_table[2][8][12] = 0.
    ...
    prior_table[5][8][11] = 0.
    prior_table[5][8][12] = 0.
    ...
    prior_table[6][8][11] = 0.
    prior_table[6][8][12] = 0.
    ...
    prior_table[9][8][11] = 0.
    prior_table[9][8][12] = 0.

    prior_table[10][8][0] = 0.
    prior_table[10][8][1] = 0.
    prior_table[10][8][2] = 0.
    prior_table[10][8][3] = 0.
    prior_table[10][8][4] = 0.
    prior_table[10][8][5] = 0.
    prior_table[10][8][6] = 0.
    prior_table[10][8][7] = 0.
    prior_table[10][8][8] = 0.
    prior_table[10][8][9] = 0.
    prior_table[10][8][10] = 0.
    prior_table[10][8][11] = 0.
    prior_table[10][8][12] = 0.
    ...
    prior_table[1][10][0] = 0.
    prior_table[1][10][1] = 0.
    prior_table[1][10][2] = 0.
    prior_table[1][10][3] = 0.
    prior_table[1][10][4] = 0.
    prior_table[1][10][5] = 0.
    prior_table[1][10][6] = 0.
    prior_table[1][10][7] = 0.
    prior_table[1][10][8] = 0.
    prior_table[1][10][9] = 0.
    prior_table[1][10][10] = 0.
    prior_table[1][10][11] = 0.
    prior_table[1][10][12] = 0.

    prior_table[2][10][0] = 0.
    prior_table[2][10][1] = 0.
    prior_table[2][10][2] = 0.
    prior_table[2][10][3] = 0.
    prior_table[2][10][4] = 0.
    prior_table[2][10][5] = 0.
    prior_table[2][10][6] = 0.
    prior_table[2][10][7] = 0.
    prior_table[2][10][8] = 0.
    prior_table[2][10][9] = 0.
    prior_table[2][10][10] = 0.
    prior_table[2][10][11] = 0.
    prior_table[2][10][12] = 0.

    prior_table[3][10][0] = 0.
    prior_table[3][10][1] = 0.
    prior_table[3][10][2] = 0.
    prior_table[3][10][3] = 0.
    prior_table[3][10][4] = 0.
    prior_table[3][10][5] = 0.
    prior_table[3][10][6] = 0.
    prior_table[3][10][7] = 0.
    prior_table[3][10][8] = 0.
    prior_table[3][10][9] = 0.
    prior_table[3][10][10] = 0.
    prior_table[3][10][11] = 0.
    prior_table[3][10][12] = 0.

    prior_table[4][10][0] = 0.
    prior_table[4][10][1] = 0.
    prior_table[4][10][2] = 0.
    prior_table[4][10][3] = 0.
    prior_table[4][10][4] = 0.
    prior_table[4][10][5] = 0.
    prior_table[4][10][6] = 0.
    prior_table[4][10][7] = 0.
    prior_table[4][10][8] = 0.
    prior_table[4][10][9] = 0.
    prior_table[4][10][10] = 0.
    prior_table[4][10][11] = 0.
    ...
    prior_table[8][10][0] = 0.
    prior_table[8][10][1] = 0.
    prior_table[8][10][2] = 0.
    prior_table[8][10][3] = 0.
    prior_table[8][10][4] = 0.
    prior_table[8][10][5] = 0.
    prior_table[8][10][6] = 0.
    prior_table[8][10][7] = 0.
    prior_table[8][10][8] = 0.
    prior_table[8][10][9] = 0.
    prior_table[8][10][10] = 0.
    prior_table[8][10][11] = 0.
    ...
    prior_table[12][10][0] = 0.
    prior_table[12][10][1] = 0.
    prior_table[12][10][2] = 0.
    prior_table[12][10][3] = 0.
    prior_table[12][10][4] = 0.
    prior_table[12][10][5] = 0.
    prior_table[12][10][6] = 0.
    prior_table[12][10][7] = 0.
    prior_table[12][10][8] = 0.
    prior_table[12][10][9] = 0.
    prior_table[12][10][10] = 0.
    prior_table[12][10][11] = 0.
    ...
    prior_table[1][11][0] = 0.
    prior_table[1][11][1] = 0.
    prior_table[1][11][2] = 0.
    prior_table[1][11][3] = 0.
    prior_table[1][11][4] = 0.
    prior_table[1][11][5] = 0.
    prior_table[1][11][6] = 0.
    prior_table[1][11][7] = 0.
    prior_table[1][11][8] = 0.
    prior_table[1][11][9] = 0.
    prior_table[1][11][10] = 0.
    prior_table[1][11][11] = 0.
    prior_table[1][11][12] = 0.

    prior_table[2][11][0] = 0.
    prior_table[2][11][1] = 0.
    prior_table[2][11][2] = 0.
    prior_table[2][11][3] = 0.
    prior_table[2][11][4] = 0.
    prior_table[2][11][5] = 0.
    prior_table[2][11][6] = 0.
    prior_table[2][11][7] = 0.
    prior_table[2][11][8] = 0.
    prior_table[2][11][9] = 0.
    prior_table[2][11][10] = 0.
    prior_table[2][11][11] = 0.
    prior_table[2][11][12] = 0.

    prior_table[3][11][0] = 0.
    prior_table[3][11][1] = 0.
    prior_table[3][11][2] = 0.
    prior_table[3][11][3] = 0.
    prior_table[3][11][4] = 0.
    prior_table[3][11][5] = 0.
    prior_table[3][11][6] = 0.
    prior_table[3][11][7] = 0.
    prior_table[3][11][8] = 0.
    prior_table[3][11][9] = 0.
    prior_table[3][11][10] = 0.
    prior_table[3][11][11] = 0.
    prior_table[3][11][12] = 0.

    prior_table[4][11][0] = 0.
    prior_table[4][11][1] = 0.
    prior_table[4][11][2] = 0.
    prior_table[4][11][3] = 0.
    prior_table[4][11][4] = 0.
    prior_table[4][11][5] = 0.
    prior_table[4][11][6] = 0.
    prior_table[4][11][7] = 0.
    prior_table[4][11][8] = 0.
    prior_table[4][11][9] = 0.
    prior_table[4][11][10] = 0.
    prior_table[4][11][11] = 0.
    prior_table[4][11][12] = 0.

    prior_table[5][11][0] = 0.
    prior_table[5][11][1] = 0.
    prior_table[5][11][2] = 0.
    prior_table[5][11][3] = 0.
    prior_table[5][11][4] = 0.
    prior_table[5][11][5] = 0.
    prior_table[5][11][6] = 0.
    prior_table[5][11][7] = 0.
    prior_table[5][11][8] = 0.
    prior_table[5][11][9] = 0.
    prior_table[5][11][10] = 0.
    prior_table[5][11][11] = 0.
    prior_table[5][11][12] = 0.
    ...
    prior_table[9][11][0] = 0.
    prior_table[9][11][1] = 0.
    prior_table[9][11][2] = 0.
    prior_table[9][11][3] = 0.
    prior_table[9][11][4] = 0.
    prior_table[9][11][5] = 0.
    prior_table[9][11][6] = 0.
    prior_table[9][11][7] = 0.
    prior_table[9][11][8] = 0.
    prior_table[9][11][9] = 0.
    prior_table[9][11][10] = 0.
    prior_table[9][11][11] = 0.
    prior_table[9][11][12] = 0.
    ...
    prior_table[1][12][7] = 0.
    prior_table[1][12][8] = 0.
    prior_table[1][12][9] = 0.
    prior_table[1][12][10] = 0.
    prior_table[1][12][11] = 0.
    prior_table[1][12][12] = 0.

    prior_table[2][12][0] = 0.
    ...
    prior_table[2][12][7] = 0.
    prior_table[2][12][8] = 0.
    prior_table[2][12][9] = 0.
    prior_table[2][12][10] = 0.
    prior_table[2][12][11] = 0.
    prior_table[2][12][12] = 0.

    prior_table[3][12][0] = 0.
    ...
    prior_table[3][12][7] = 0.
    prior_table[3][12][8] = 0.
    prior_table[3][12][9] = 0.
    prior_table[3][12][10] = 0.
    prior_table[3][12][11] = 0.
    prior_table[3][12][12] = 0.

    prior_table[4][12][0] = 0.
    ...
    prior_table[4][12][7] = 0.
    prior_table[4][12][8] = 0.
    prior_table[4][12][9] = 0.
    prior_table[4][12][10] = 0.
    prior_table[4][12][11] = 0.
    prior_table[4][12][12] = 0.

    prior_table[5][12][0] = 0.
    ...
    prior_table[5][12][7] = 0.
    prior_table[5][12][8] = 0.
    prior_table[5][12][9] = 0.
    prior_table[5][12][10] = 0.
    prior_table[5][12][11] = 0.
    prior_table[5][12][12] = 0.

    prior_table[6][12][0] = 0.
    ...
    prior_table[6][12][7] = 0.
    prior_table[6][12][8] = 0.
    prior_table[6][12][9] = 0.
    prior_table[6][12][10] = 0.
    prior_table[6][12][11] = 0.
    prior_table[6][12][12] = 0.
    ...
    prior_table[9][12][7] = 0.
    prior_table[9][12][8] = 0.
    prior_table[9][12][9] = 0.
    prior_table[9][12][10] = 0.
    prior_table[9][12][11] = 0.
    prior_table[9][12][12] = 0.

    prior_table[10][12][0] = 0.
    ...
    prior_table[10][12][7] = 0.
    prior_table[10][12][8] = 0.
    prior_table[10][12][9] = 0.
    prior_table[10][12][10] = 0.
    prior_table[10][12][11] = 0.
    prior_table[10][12][12] = 0.
    ...
    for pre_last in np.arange(13):
        for last in np.arange(13):
            sum = np.sum(stat_table[pre_last][last])
            if sum != 0:
                stat_table[pre_last][last] /= sum
    ...
    for pre_last in np.arange(13):
        for last in np.arange(13):
            sum = np.sum(posterior_table[pre_last][last])
            if sum != 0:
                posterior_table[pre_last][last] /= sum
    ...
    posterior_table[6][0][0] = 0.
    posterior_table[6][0][1] = 0.
    posterior_table[6][0][2] = 0.
    posterior_table[6][0][3] = 0.
    posterior_table[6][0][4] = 0.
    posterior_table[6][0][5] = 0.
    posterior_table[6][0][6] = 0.
    posterior_table[6][0][7] = 0.
    posterior_table[6][0][8] = 0.
    posterior_table[6][0][9] = 0.
    posterior_table[6][0][10] = 0.
    posterior_table[6][0][11] = 0.
    posterior_table[6][0][12] = 0.

    posterior_table[7][0][0] = 0.
    posterior_table[7][0][1] = 0.
    posterior_table[7][0][2] = 0.
    posterior_table[7][0][3] = 0.
    posterior_table[7][0][4] = 0.
    posterior_table[7][0][5] = 0.
    posterior_table[7][0][6] = 0.
    posterior_table[7][0][7] = 0.
    posterior_table[7][0][8] = 0.
    posterior_table[7][0][9] = 0.
    posterior_table[7][0][10] = 0.
    posterior_table[7][0][11] = 0.
    posterior_table[7][0][12] = 0.
